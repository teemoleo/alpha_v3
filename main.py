...
class MainFirstWindow(Screen):
    def __init__(self, **kwargs):
        ...
        with self.canvas:
            ...
            self.mapimage = Rectangle(pos = (dp(0),dp(100)), size = (dp(410),dp(800)), source = '2nd_Floor_Main.png')

            Color(1,0,0,1, mode = "rgba")
            self.rect = Line(pos = (dp(0),dp(0)), size = (dp(20),dp(20)))

            Color(0,1,0,1, mode = "rgba")
            self.start_rect = Rectangle(pos = (dp(0),dp(0)), size = (dp(10),dp(10)))

            Color(1,0,0,1, mode = "rgba")
            self.end_rect = Rectangle(pos = (dp(0),dp(0)), size = (dp(10),dp(10)))
